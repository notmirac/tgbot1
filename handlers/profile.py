...
async def process_age(message: Message, state: FSMContext) -> None:
    ...
    await message.answer(tr(lang, "profile_choose_gender"), reply_markup=gender_keyboard(lang), parse_mode="HTML")
...
async def save_new_name(message: Message, state: FSMContext) -> None:
    ...
    await state.set_state(ChatStates.main_menu)
    await message.answer(tr(lang, "edit_name_ok", value=name), reply_markup=main_menu_keyboard(lang), parse_mode="HTML")
...
async def save_new_age(message: Message, state: FSMContext) -> None:
    ...
    await state.set_state(ChatStates.main_menu)
    await message.answer(tr(lang, "edit_age_ok", value=age), reply_markup=main_menu_keyboard(lang), parse_mode="HTML")
